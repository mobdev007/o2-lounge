 ...
 */
public class DMenuAdapter extends RecyclerView.Adapter<DMenuAdapter.ViewHolder> {
    ...
    public DMenuAdapter(Context context, List<MenuItemObj> menuItemObjList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = inflater.inflate(R.layout.card_view_home, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.tvItemDes.setText(nature.getDes());
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            tvItemName = (TextView) itemView.findViewById(R.id.tv_nature);
            tvItemDes = (TextView) itemView.findViewById(R.id.tv_des_nature);
            tvItemMRP = (TextView) itemView.findViewById(R.id.tv_mrp);
            bt_add = (Button) itemView.findViewById(R.id.button_add_cart);
            bt_remove = (Button) itemView.findViewById(R.id.button_remove_cart);
