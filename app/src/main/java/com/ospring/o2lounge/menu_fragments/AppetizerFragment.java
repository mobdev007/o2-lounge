...
public class AppetizerFragment extends Fragment {
    ...
    public List<MenuItemObj> getData(Resources resources) {
        ...
        String[] menu_items = resources.getStringArray(R.array.food_appetizer_menu);
        String[] menu_price = resources.getStringArray(R.array.food_appetizer_price);
        String[] cart_count = getCartCount(menu_items);
        String[] menu_items_des = resources.getStringArray(R.array.food_appetizer_des);
        int[] img_array = new int[]{R.drawable.french_fries, R.drawable.masala_french_fries, R
                .drawable.potato_wedges, R.drawable.tortilla_nachos, R.drawable.chilly_paneer, R.drawable
                .schezwan_paneer};
